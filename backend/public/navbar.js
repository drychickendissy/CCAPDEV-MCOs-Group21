class Navbar extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `
    <div class="navbar">
      ${this.tab("home", "/home", tabs.home.color, tabs.home.text, tabs.home.icon, tabs.home.hoverIcon, active)}
    ...
    <div class="navbar-auth">
      ${isLoggedIn
        ...
        : '<a href="/login" class="nav-auth-btn poppins-extrabold" data-auth-action="login">Login</a>'
      }
    </div>
    `;
